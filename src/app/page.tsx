            ...
            <div className="z-10 w-full max-w-4xl">
                ...
                <div className="text-center mt-8 sm:mt-12 neutro-box p-4 sm:p-6 backdrop-blur-sm bg-background/30">
                    ...
                    <p className="text-xl sm:text-2xl">
                        1) Your mails are public. Don&apos;t use it for
                        important mails. Use it to subscribe to all unwanted
                        services.
                    </p>
                    <p className="text-xl sm:text-2xl mt-3">
                        2) Your mails will be cleared from the database to
                        prevent junk after 7 days. Please save all the data that
